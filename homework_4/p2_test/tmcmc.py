...
if __name__ == '__main__':
    ...
    found = e.loadState('_korali_result/gen00000011.json')
    print(found)
    ...
    e["Solver"]["Termination Criteria"]["Max Generations"] = 15
    #e["Max Generations"] = 15
    #e["Termination Criteria"]["Max Model Evaluations"] = 1e9
    #e["Termination Criteria"]["Target Annealing Exponent"] = 1.0
    #e["Solver"]["Max Generations"] = 15
